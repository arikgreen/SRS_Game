...
namespace Iml.Documentation
{
  ...
  public partial class Parameter
  {
    ...
    public static Parameter Parse (string str)
    {
      ...
      if (TryParse(str, out result))
        return result;
      throw new FormatException(String.Format("Cannot parse Parameter from string \"{0}\"", str));
    }
    ...
    /// <returns></returns>
    public static bool TryParse (string str, out Parameter value)
    {
      return FormatHelper.TryParse<Parameter>(str, out value);
    }
  ...
  /// </summary>
  public partial class ParameterTypeConverter : TypeConverter
  {
    /// <summary>
    ...
    public override object ConvertFrom (ITypeDescriptorContext context, CultureInfo culture, object value)
    {
      if (value is string)
      {
        Parameter result = Parameter.Parse(value as string);
        return result;
      }
      else
