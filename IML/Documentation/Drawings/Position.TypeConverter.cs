...
namespace Iml.Documentation.Drawings
{
    ...
    public partial class Position
    {
        ...
        /// <returns></returns>
        public static bool TryParse(string str, out Position value)
        {
            return FormatHelper.TryParse<Position>(str, out value);
        }
    ...
    /// </summary>
    public partial class PositionTypeConverter : TypeConverter
    {
        /// <summary>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            if (value is string)
            {
                Position result = Position.Parse(value as string);
                return result;
            }
            else
