...
namespace Iml.Documentation.VML
{
  ...
  public partial class Shadow
  {
    ...
    public static Shadow Parse (string str)
    {
      ...
      if (TryParse(str, out result))
        return result;
      throw new FormatException(String.Format("Cannot parse Shadow from string \"{0}\"", str));
    }
    ...
    /// <returns></returns>
    public static bool TryParse (string str, out Shadow value)
    {
      return FormatHelper.TryParse<Shadow>(str, out value);
    }
  ...
  /// </summary>
  public partial class ShadowTypeConverter : TypeConverter
  {
    /// <summary>
    ...
    public override object ConvertFrom (ITypeDescriptorContext context, CultureInfo culture, object value)
    {
      if (value is string)
      {
        Shadow result = Shadow.Parse(value as string);
        return result;
      }
      else
