...
namespace Iml.Documentation.VML
{
  ...
  public partial class Fill
  {
    ...
    public static Fill Parse (string str)
    {
      ...
      if (TryParse(str, out result))
        return result;
      throw new FormatException(String.Format("Cannot parse Fill from string \"{0}\"", str));
    }
    ...
    /// <returns></returns>
    public static bool TryParse (string str, out Fill value)
    {
      return FormatHelper.TryParse<Fill>(str, out value);
    }
  ...
  public partial class FillTypeConverter : TypeConverter
  {
    ...
    public override object ConvertFrom (ITypeDescriptorContext context, CultureInfo culture, object value)
    {
      if (value is string)
      {
        Fill result = Fill.Parse(value as string);
        return result;
      }
      else
    ...
    {
      if (destinationType == typeof(string) && value is Fill)
      {
        Fill val = (Fill)value;
        return val.ToString();
      }
