...
namespace Iml.Documentation.Colors
{
  public partial class ShiftColorMember
  {
    ...
    /// <param name="s"></param>
    /// <returns></returns>
    public new static ShiftColorMember Parse (string s)
    {
      ShiftColorMember result;
      if (TryParse(s, out result))
        return result;
      throw new FormatException("Invalid ShiftColorMember string format");
    }
    ...
    /// <returns></returns>
    public static bool TryParse (string s, out ShiftColorMember result)
    {
      result = null;
      if (s != null)
      {
